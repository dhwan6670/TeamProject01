...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
        ...
        function checkValue()
        {
            ...
            var log = "${sessionScope.logOK}"
            var comment_id = "${logOK.member_id}";
            ...
            if(!comment_content)
            {
                ...
                location.href="/TeamProject/comments.do?num="+comment_num+"&content="+comment_content+"&boardnum="+comment_boardnum+"&id="+comment_id;
            }
        }
