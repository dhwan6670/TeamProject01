...
<table class="pic">
	<caption><h1>피파 온라인 4</h1></caption>
	<tr>
		<td><img src="./game_poster/fifa.png"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>EA 산하의 EA 코리아 스튜디오에서 개발하고 넥슨이 배급하는<br>
		피파온라인 3의 후속작이다. 피파 18을 원작으로 두고 있다.<br>
		전 세계 축구 리그의 선수들로 개인 혹은 친구들과 함께<br>
		다양한 모드를 플레이할 수 있는 온라인 축구 게임이다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="fifa4">
