...
<table class="pic">
	<caption><h1>AMONG US</h1></caption>
	<tr>
		<td><img src="./game_poster/amongus.jpg"></td>
	</tr>
	<tr>
		<td>평균 별점<br>
			<c:choose>
	...
	<tr>
		<td>'우리들 중에'라는 뜻을 가진 온라인 다인용 소셜 디덕션 게임이다.<br>
		마피아 형식의 생존 게임으로 iOS, 안드로이드용 모바일 게임으로 먼저 출시했고,<br>
		이후 스팀, 닌텐도 스위치에도 출시되었으며, Xbox 시리즈로도 출시될 예정이다.<br>
		출시 초반에는 인기가 많지 않았지만 COVID-19의 대유행과 맞물려<br>
		그야말로 폭발적인 인기를 끌고 있다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="amongus">
