...
<table class="pic">
	<caption><h1>영원회귀 : 블랙서바이벌</h1></caption>
	<tr>
		<td><img src="./game_poster/erbs.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>넵튠의 자회사 님블류런에서 만든 쿼터뷰 배틀로얄 게임이다.<br>
		한 게임당 최대 18명의 플레이어가 참여하여 파밍한 물품들을 이용해<br>
		장비와 음식을 만들고 활용하는 배틀로얄 게임으로,<br>
		공중전화를 이용한 순간이동과 수많은 트랩들을 통한 다양한 전략으로<br>
		최후의 1인 혹은 1팀을 가려내는 게임이다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="eternalreturn">
