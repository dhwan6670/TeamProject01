...
<table class="pic">
	<caption><h1>서든어택</h1></caption>
	<tr>
		<td><img src="./game_poster/sa.png"></td>
	</tr>
	<tr>
		<td>평균 별점<br>
			<c:choose>
	...
	<tr>
		<td>넥슨GT에서 제작하고 넥슨이 배급하는 온라인 FPS 게임.<br>
		게임모드는 목표를 기준으로 데스매치와 점령미션, 폭파미션,<br>
		탈취미션, 터치다운, 인질구출, 헤드헌트, 런어웨이 등이 있으며,<br>
		사용가능한 무기를 기준으로 칼전, 권총전, 샷건전 등이 있다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="suddenattack">
