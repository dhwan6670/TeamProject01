...
<table class="pic">
	<caption><h1>스타크래프트</h1></caption>
	<tr>
		<td><img src="./game_poster/star.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>블리자드 엔터테인먼트에서 제작한 RTS 게임으로, 스타크래프트 오리지널은<br>
		1998년 3월 31일에 출시하였다. 게임 내 등장하는 테란, 프로토스, 저그<br>
		세 종족은 그 전 RTS 게임으로는 그 유례를 찾아볼 수 없을 만큼 특징과 개성이 매우 뚜렷하다.<br>
		2017년 8월 14일, 스타크래프트 리마스터를 출시하면서 최대 4K 해상도, 고음질 원본 음향,<br>
		완전히 새롭게 제작된 유닛, 건물, 효과, 초상화, 유저 인터페이스,<br>
		그리고 등급전 기능을 지원받을 수 있게되었다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="starcraft">
