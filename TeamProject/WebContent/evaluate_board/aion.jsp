...
<table class="pic">
	<caption><h1>아이온</h1></caption>
	<tr>
		<td><img src="./game_poster/aion.png"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>엔씨소프트에서 개발 및 서비스 중인 판타지 설정의 대규모 MMORPG.<br>
		천계와 마계로 분열된 세계관 속에서 천족, 마족, 용족이<br>
		이상과 종족의 생존을 위해 끊임없이 싸우는 모습을 그린다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="aion">
