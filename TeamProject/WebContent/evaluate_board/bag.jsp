...
<table class="pic">
	<caption><h1>PLAYERUNKNOWN'S BATTLEGROUNDS</h1></caption>
	<tr>
		<td><img src="./game_poster/bag.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>PLAYERUNKNOWN'S BATTLEGROUNDS, 약칭 배틀그라운드는<br>
		크래프톤의 자회사인 펍지 주식회사의 MMO 슈팅 게임이다.<br>
		최대 100명의 인원이 무기와 탈 것을 활용하면서 벌이는<br>
		배틀로얄 게임으로, 방대한 오픈 월드 맵에서 물품을 얻고<br>
		다양한 전략을 이용해 싸우면서 최후의 1인 혹은 1팀을 가려내는 게임이다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="bag">
