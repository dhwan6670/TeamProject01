...
<table class="pic">
	<caption><h1>오버워치</h1></caption>
	<tr>
		<td><img src="./game_poster/overwatch.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>블리자드 엔터테인먼트의 팀 기반 멀티플레이 하이퍼 FPS 게임이다.<br>
		게임 내 임무를 완수해서 이기는 방식으로 진행되며,<br>
		각기 다른 포지션의 수많은 영웅들과의 슈팅게임을 즐길 수 있다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="overwatch">
