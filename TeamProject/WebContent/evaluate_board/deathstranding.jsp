...
<table class="pic">
	<caption><h1>Death Stranding</h1></caption>
	<tr>
		<td><img src="./game_poster/ds.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>메탈기어 시리즈의 제작자 코지마 히데오가 코나미를 퇴사하고<br>
		코지마 프로덕션을 설립 후 제작한 게임. 2019년 최다 GOTY 수상작이다.<br>
		설정상으로 택배배송을 표방하고 있지만 탐험, 무역을 하는 느낌을 받을 수 있으며,<br>
		건설 경영 시뮬레이션의 요소도 포함되어 있다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="deathstranding">
