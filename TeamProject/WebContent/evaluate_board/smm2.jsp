...
<table class="pic">
	<caption><h1>SUPER MARIO MAKER 2</h1></caption>
	<tr>
		<td><img src="./game_poster/smm.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>Nintendo Switch로 발매된 슈퍼 마리오 메이커의 속편이다.<br>
		'만들고 플레이'라는 장르명에 따라 직접 코스를 만들고,<br>
		자신과 다른 사람이 만든 코스를 플레이할 수 있다. 본 작품은<br>
		전작에 비해 스토리 모드, 온라인 멀티 플레이 등이 추가된다는 소식에<br>
		출시 전부터 많은 기대를 받았다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="smm2">
