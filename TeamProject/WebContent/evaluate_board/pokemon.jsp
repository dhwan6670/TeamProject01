...
<table class="pic">
	<caption><h1>포켓몬스터 1세대</h1></caption>
	<tr>
		<td><img src="./game_poster/pr.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>포켓몬스터 적·녹·청·피카츄가 1세대 포켓몬 게임에 속한다.<br>
		각 포켓몬 디자인은 몇번이나 고치는 장고 끝에 결정된 것으로 알려져 있음과 동시에<br>
		대부분의 유저들이 호평하는 세대이다. 1996년 2월에 발매되었으며, 슬슬 인기가<br>
		떨어져가던 게임보이를 기사회생시킨 작품으로도 알려져 있다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="pokemon">
