...
<table class="pic">
	<caption><h1>어쌔신 크리드 발할라</h1></caption>
	<tr>
		<td><img src="./game_poster/assassin.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>유비소프트 몬트리올에서 개발한 어쌔신 크리드 시리즈의 12번쨰<br>
		메인 시리즈 작품으로 9세기 이교도 대군세 시기의 그레이트브리튼 섬과<br>
		스칸디나비아 반도를 배경으로 한다. 주인공은 에이보르라는 이름의<br>
		노르웨이 출신 바이킹 전사이며, 개임 내에서 바이킹의 전투를 실감할 수 있다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="valhalla">
