...
<table class="pic">
	<caption><h1>FALL GUYS</h1></caption>
	<tr>
		<td><img src="./game_poster/fg.jpg"></td>
	</tr>
	<tr>
		<td>평균 별점<br>
			<c:choose>
	...
	<tr>
		<td>런던의 게임 개발사 미디어토닉에서 개발하고 디볼버 디지털이 유통하는<br>
		대규모 멀티플레이 파티 게임. 가벼운 룰을 가진 게임들을 모아서<br>
		서바이벌 룰을 가미한 느낌이며, 총 플레이어 60명 중 최후의 1인이<br>
		승리할 때까지 총 2~7라운드의 게임을 진행한다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="fallguys">
