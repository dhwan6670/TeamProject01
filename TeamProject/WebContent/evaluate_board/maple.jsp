...
<table class="pic">
	...
	<tr>
		<td>위젯 스튜디오에서 제작하고 넥슨이 유통하는 온라인 게임으로,<br>
		장르는 MMORPG이다. 2D 횡스크롤 방식으로 진행되며,<br>
		다채로운 필드에서의 여행과 모험을 즐길 수 있다.<br>
		캐치 프레이즈는 '끊임없는 즐거움, 스스로 만들어 나가는 이야기, 상상 속의 세계'</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="maple">
