...
<table class="pic">
	<caption><h1>환세취호전</h1></caption>
	<tr>
		<td><img src="./game_poster/hwanse.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>환세 시리즈 중 하나로 컴파일의 명작 RPG. 깔끔한 스토리라인과<br>
		캐릭터, 시리즈 특유의 맛을 살린 무협적 세계관, 6개월의 개발기간과<br>
		4메가바이트의 용량이라고는 믿을 수 없는 완성도와 쾌적한 플레이 등<br>
		'고전게임' 하면 반드시 이름이 오르내리는 걸작이다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="hwansechwihojeon">
