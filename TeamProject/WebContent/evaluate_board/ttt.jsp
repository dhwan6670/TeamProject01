...
<table class="pic">
	...
	<tr>
		<td><img src="./game_poster/ttt.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>1999년 7월 15일에 아케이드로 발매된 철권시리즈.<br>
		철권 3의 외전이자 태그배틀 시스템을 도입한 업그레이드판이다.<br>
		철권 6 이전 시리즈 최다 캐릭터인 33명이 등장한다. 이처럼 풍성한 캐릭터 구성,<br>
		호쾌한 타격감, 뛰어난 게임성 등으로 한국에서 폭발적인 인기몰이를 했다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="ttt">
