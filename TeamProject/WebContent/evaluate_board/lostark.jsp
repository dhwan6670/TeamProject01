...
<table class="pic">
	<caption><h1>로스트아크</h1></caption>
	<tr>
		<td><img src="./game_poster/la.jpg"></td>
	</tr>
	<tr>
		<td>평균 별점<br>
			<c:choose>
	...
	<tr>
		<td>게임 개발사 및 퍼블리셔인 스마일게이트 RPG가 개발한 쿼터뷰 액션 MMORPG다.<br>
		거대한 세계관과 블록버스터급 핵&슬래시 스타일의 전투,<br>
		방대한 컨텐츠가 특징으로, 잃어버린 아크를 찾기 위해<br>
		아크라시아 대륙을 모험하는 모험가들의 이야기이다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="lostark">
