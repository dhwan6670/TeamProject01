...
<table class="pic">
	<caption><h1>파랜드 택틱스 2</h1></caption>
	<tr>
		<td><img src="./game_poster/ft.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>일본 기준 1997년 5월 30일에 발매된 일본 전통 RPG.<br>
		특출난 요소보다는 스토리와 CG, BGM과 같은 기본적인 요소에<br>
		충실한 작품이다. 레벨디자인이나 번역 등이 아쉬운 부분으로 남지만<br>
		한국에서도 수많은 게이머들이 명작으로 꼽는다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="farlandtactics2">
