...
<table class="pic">
	<caption><h1>DOOM</h1></caption>
	<tr>
		<td><img src="./game_poster/doom.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>1993년 12월 10일 발매된 FPS 게임. 둠 시리즈의 첫 작품이다.<br>
		게임계 역사에 매우 커다란 영향을 끼친 게임 중 하나다. 혁신적인 3D 그래픽을<br>
		선보이며 기술적인 충격을 주었으며, 네트워크 대전을 지원하여 멀티플레이의 대중화를 이끌었다.<br></td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="doom">
