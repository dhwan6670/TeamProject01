...
<table class="pic">
	<caption><h1>Ray Man</h1></caption>
	<tr>
		<td><img src="./game_poster/rm.jpg"></td>
	</tr>
	<tr>
		<td>평균 별점<br>
			<c:choose>
	...
	<tr>
		<td>유비소프트가 소유한 플랫폼 비디오 게임 시리즈.<br>
		뛰어난 조작감과 아기자기하고 깔끔한 그래픽, 아름다운 음악으로<br>
		유명한 고전 명작 게임이다. 동화와도 같은 매우 단순하면서도<br>
		직관적인 줄거리를 갖고 있으며 겉과는 다르게 굉장히 어려운 난이도로<br>
		악명이 자자하다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="rayman">
