...
<table class="pic">
	<caption><h1>라스트 오브 어스 2</h1></caption>
	<tr>
		<td><img src="./game_poster/lou.png"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>PSX에서 공개된 액션 어드벤쳐 게임.<br>
		명작으로 칭송받던 '더 라스트 오브 어스'의 후속작으로,<br>
		본 게임의 크리에이티브 디렉터 닐 드럭만은 "당신이 사랑했던 사람이<br>
		잔인하고 폭력적인 행위의 희생자라면 당신은 어떻게 하시겠습니까?"라는 메시지를 남겼다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="lastofus2">
