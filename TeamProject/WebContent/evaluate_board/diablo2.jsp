...
<table class="pic">
	<caption><h1>Diablo 2</h1></caption>
	<tr>
		<td><img src="./game_poster/dia.png"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>블리자드 엔터테인먼트에서 2000년 6월 29일에 발매한<br>
		디아블로 시리즈의 2번째 작품. 쿼터뷰 ARPG의 정점이자, 디아블로 시리즈의<br>
		최고작이라는 평을 받는다. 전작의 다크 판타지와 공포를 훌륭하게 이어받았으며,<br>
		장대한 스토리라인을 자랑한다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="diablo2">
