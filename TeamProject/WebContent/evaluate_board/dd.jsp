...
<table class="pic">
	<caption><h1>Dungeons & Dragons</h1></caption>
	<tr>
		<td><img src="./game_poster/dd.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>미국 TSR에서 1970년대에 내놓은 RPG. 주로 D&D라는 약칭으로 불린다.<br>
		판타지 세계관에 규칙을 도입하여 게임화한 최초의 RPG이다. 즉, RPG라는 개념의 시초,<br>
		지구상 모든 RPG의 뿌리라 할 수 있다. 모험가들이 작당하여 괴물들이 사는 동굴에<br>
		들어가 온갖 고초를 겪고서 보물과 경험치를 챙겨 나오는 모험을 즐길 수 있다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="dd">
