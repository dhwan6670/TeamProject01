...
<table class="pic">
	<caption><h1>RollerCoaster Tycoon</h1></caption>
	<tr>
		<td><img src="./game_poster/rct.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>1999년 3월 22일에 발매된 롤러코스터 타이쿤 시리즈의 첫 작품.<br>
		플레이어가 놀이공원을 만들어 경영하는 건설경영 시뮬레이션 게임.<br>
		방문객들을 구렁텅이에 떨어뜨리거나 하늘로 승천시키는 등의 소위 말하는<br>
		'빌런'들의 막장 운영이 자주 자행된다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="rollercoastertycoon">
