...
<table class="pic">
	<caption><h1>리그 오브 레전드</h1></caption>
	<tr>
		<td><img src="./game_poster/lol.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>라이엇 게임즈에서 개발 및 서비스 중인 MOBA(AOS) 장르의 게임으로,<br>
		국내에서는 게임 명칭 앞의 글자들을 따서 롤(LoL)이라 부른다.<br>
		5명의 챔피언으로 구성된 양 팀이 서로의 기지를 파괴하기 위해<br>
		치열한 사투를 벌이는 전략 게임이다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="lol">
