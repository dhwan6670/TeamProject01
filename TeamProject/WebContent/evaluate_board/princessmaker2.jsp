...
<table class="pic">
	<caption><h1>Princess Maker 2</h1></caption>
	<tr>
		<td><img src="./game_poster/pm.png"></td>
	</tr>
	<tr>
		<td>평균 별점<br>
			<c:choose>
	...
	<tr>
		<td>가이낙스가 1993년 6월 15일 PC-9801에 발매한<br>
		프린세스 메이커 시리즈의 2번째 작품. 전작만한 속편 없다는<br>
		징크스를 깬 프린세스 메이커 시리즈로, 육성 시뮬레이션 최고의 명작으로 꼽힌다.<br></td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="princessmaker2">
