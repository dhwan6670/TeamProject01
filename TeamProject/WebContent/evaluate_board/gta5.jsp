...
<table class="pic">
	<caption><h1>GTA5</h1></caption>
	<tr>
		<td><img src="./game_poster/gta.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>락스타 게임즈에서 개발한 Grand Theft Auto 시리즈의 15번째 작품.<br>
		동네 건달과 은퇴한 은행 강도, 미치광이 사이코패스와 함께 어두운 범죄 세계와<br>
		미국 정부 기관, 엔터테인먼트 회사 등의 끔찍하고 무시무시한 음모를<br>
		파헤쳐나가는 모습을 그린다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="gta5">
