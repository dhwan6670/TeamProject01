...
<table class="pic">
	<caption><h1>사이버펑크 2077</h1></caption>
	<tr>
		<td><img src="./game_poster/cp.jpg"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>CD PROJEKT RED가 개발한 1인칭 오픈월드 액션 RPG.<br>
		권력, 사치와 신체 개조에 집착하는 거대도시 나이트 시티를 배경으로 하며,<br>
		주인공 V는 사이버웨어와 다양한 능력을 활용할 수 있다.<br>
		거대한 도시를 탐험하며 주인공의 선택과 결정이 스토리 전개 뿐만 아니라<br>
		근미래 세계에 어떤 영향을 끼치는지 확인할 수 있다.</td>
	</tr>
</table>
...
<c:if test="${log.member_name!=null}">
	<table class="eval">
		...
		<form id="evalform">
			<td>
				${log.member_name}
				<input type="hidden" name="eval_game" value="cyberpunk">
